    ...
    return Scaffold(
      body: SafeArea(
        child: PageView(
          ...
          children: [
            PaymentTile(image: 'assets/images/onboarding2.png',
            title: 'Make Payments using\nQRCodes and URL ',
              ...
              color1: Color(0XFF9FA8DA),color2: Color(0xFF1A237E),),
              PaymentTile(image: 'assets/images/onboarding1.png',
              title: '      Achieve your financial goals\n      by budgetting wisely',
              description:'Lets help you spend wisely by giving you\nthe superpower' 
              'to create a swift and\ndetailed budget list.\n' 
               'You create the budget, we automate and\nkeep you accountable.',
              color1: Color(0XFFBBDEFB),color2: Color(0xFF42539E)
               ),
               PaymentTile(image: 'assets/images/onboarding3.png',
                title: '   Automate Utility Payments',
               description: 'Never go late on any utility payment again\nwith Dashr.\n'
              'By automating payments, all your utility\nbills get paid off seamless without\nbreaking a sweat',
             color1: Color(0XFFC5CAE9),color2: Color(0xFF1A237E))
                ...
                child: Column(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        style: ElevatedButton.styleFrom(side: BorderSide(color: Colors.white,width: 2),
